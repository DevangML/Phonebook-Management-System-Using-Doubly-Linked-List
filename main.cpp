...
void dlist::accept()
{
  ...
  do
  {
    ...
    std::ofstream out("phonebook.txt", ios::app);
    out << "Name: " + convertToString(name) << endl;
    out << "Phone No: " + convertToString(number) << endl;
    out << "Gmail: " + convertToString(gmail) << endl;
    out << endl;
...
void dlist::displayFromFile()
{
  ofstream out("ads.txt", ios::app);
  string st;
